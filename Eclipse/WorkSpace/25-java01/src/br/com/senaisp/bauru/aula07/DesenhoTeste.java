...
public class DesenhoTeste {
	...
	public static void main(String[] args) {
		...
		dlg.setSize(800, 600);
		//Mostra quantidade instacias
		System.out.println("Qtde:" + Desenho.getQtdedeInstancias());
		//Criando o desenho
		Retangulo ret = new Retangulo(50, 50, 300, 200, Color.BLUE);
		Quadrado quad = new Quadrado(50, 50, 400, 0, Color.RED);
		Triangulo tri = new Triangulo(50, 50, 300, 200, Color.GREEN);
		//Mostrar quantidade instancias
		System.out.println("Qtde:" + Desenho.getQtdedeInstancias());
